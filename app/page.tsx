          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-900 rounded-xl p-8 border border-purple-900/30">
                ...
                <p className="text-gray-300">
                  "The journaling features combined with AI feedback have given me insights about myself I never
                  realized. It's like having a therapist available 24/7."
                </p>
              </div>
              ...
              <div className="bg-gray-900 rounded-xl p-8 border border-purple-900/30">
                ...
                <p className="text-gray-300">
                  "As someone who couldn't afford weekly therapy, SoulScript has been a lifesaver. The AI is
                  surprisingly insightful, and knowing real therapists review the conversations gives me confidence."
                </p>
              </div>
            </div>
          </div>
